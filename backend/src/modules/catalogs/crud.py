# catalogs/crud.py (Исправленная версия)
from sqlalchemy.ext.asyncio import AsyncSession
from sqlalchemy import select
from catalogs.models import Product, Category, Brand, Tag, Review, ProductImage
from typing import List, Optional
from decimal import Decimal # Нужно добавить этот импорт

async def get_product(session: AsyncSession, product_id: int) -> Optional[Product]: # Исправлена подсказка типа Optional[...]
